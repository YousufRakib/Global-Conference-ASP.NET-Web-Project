<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyPostView.aspx.cs" Inherits="MyPostView" %>
...
<body class="body">
   <form id="form1" runat="server">
       ...
       <div style="background-color:cadetblue;margin:auto; width:99.5%;height:650px;border:3px double white;border-radius: 10px;">
           ...
           <asp:Button ID="Button9" CssClass="ButtonY" runat="server" Text="Delete Post" OnClick="Button9_Click" ></asp:Button>
       </div>
       <div class="footer">
            <div class="footer-1">
