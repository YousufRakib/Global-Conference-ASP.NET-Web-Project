...
<body class="body">
   <form id="form1" runat="server">
        ...
        <div style="width:100%;height:150px;">
           <img src="Images/Screenshot_10.png" style="width:100%;height:150px;border-radius: 40px;"/>
        </div>
        <div class="div_content_pragraph"> 
           <br />
           <br />
           <p class="content_pragraph">
               Global Conference is the largest opportunity discovery platform for youth across the world. Millions of youth have trusted Global Conference as the most effective platform to find latest opportunities for free and avail important educational contents for continued self-development.
           </p>
           <h1>What we do</h1>
           <p class="content_pragraph">
               As a global youth development platform, Global Conference provides easy and instantaneous access to unlimited opportunities to millions of youth for free. Global Conference thrives on promoting youth development and thus, produces and delivers high-quality, value additive educational and capacity building materials. The purpose is to facilitate young people in translating every opportunity into success. Global Conference works relentlessly to create an efficacious bridge between opportunity seekers with opportunity providers for mutually beneficial development through sharing of information.
           </p>
           <h1>Why should you join</h1>
           <p class="content_pragraph">
               Thousands of youth are joining Global Conference everyday as they find the platform to be an accelerator to their personal and professional development.
                Five key reasons why you should join Youth Opportunities:<br /><br />

                1. Free access to hundreds of international opportunities<br />
                2. Get connected with successful local and global young leaders<br />
                3. Avail the opportunity of direct communication with opportunity providers and recruiters<br />
                4. Free access to  educational resources, suggestions and advice & support from experts<br />
                5. Share your success story with millions of youth.
           </p>
           <h1>Why we do it</h1>
           <p class="content_pragraph">
               Global Conference believes that ‘Access to Information’ is not a privilege rather a basic right. Despite praiseworthy development of Information Communication Technology, there exists acute deficiency in awareness level among youth about different opportunities pertaining to youth development. As a result, thousands of youth are missing out important chances for self-development in form of education, international exposure, training, and employment.
               Global Conference, thus, is working to build global awareness by sharing opportunities to ensure free and equal access regardless of geographical location.
           </p>
        </div>
       <div class="footer">
