...
public partial class BoxPost : System.Web.UI.Page
{
    ...
    protected void displaydata()
    {
        ...
        SqlDataAdapter SDA = new SqlDataAdapter("Select id,title,region,opportunitytype,heldingdate,applicationdeadline from PostForm where opportunitytype ='" + Request.QueryString["opportunitytype"] +"' AND region='" + Request.QueryString["region"] +"'", conn);
        conn.Open();
        SDA.Fill(DT);
        conn.Close();
