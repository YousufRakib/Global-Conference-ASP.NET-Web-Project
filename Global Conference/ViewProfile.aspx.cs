...
public partial class ViewProfile : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
                ...
                SqlDataAdapter sda = new SqlDataAdapter("Select fullname,username,email,password,country,city,mobile,age,image from RegistrationForm where username='" + Session["id"] + "'", conn);
