...
<body class="body">
   <form id="form1" runat="server">
       ...
       <div style="width:100%;height:150px;">
           <img src="Images/Screenshot_11.png" style="width:100%;height:150px;border-radius: 40px;"/>
       </div>
       <div class="div_content_pragraph"> 
           <br />
           <br />
           <p class="content_pragraph">
               Young people are at the heart of Global Conference and it thrives on new ideas and courageous leadership to make a positive contribution in youth development. Self-motivated people who believe in Global Conference global cause and are interested to be a part of the journey are welcome to join the team.
               Are you excited to explore your full potential? At Global Conference, we create a conducive platform for young people to educate, empower and engage them in leading innovative initiatives to make a difference in the society.
               Exciting opportunities are coming for you to get connected with us! 
           </p>
       </div>
       <div class="footer">
