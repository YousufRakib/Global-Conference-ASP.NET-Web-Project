...
<style type="text/css">
        ...
        .middle {
            ...
            width: 100%;
            height: 1350px;
            background-image: url(http://localhost:1510/Images/28.jpg);
        }
        .middle-box{
            background-color:white;
            width:40%;
            ...
            <div class="container2" style="background:none;border:10px;border-color:white;">
                <div class="signup-content" style="background:none;">
                    <form id="form1" runat="server">
                        ...
                        <div class="log-icon">
                            <img class="log-image" src="Images/RI-1.png" />
                        </div>
                    ...
                    <asp:Label ID="Label3" runat="server" Text="" style="color:red;font-style:normal;font-size:18px;text-align:center;"></asp:Label><br /><br />
                     <p style="color:white;">
                        If you want to save Username,Email,Password in cookies..After fill Up before Submit form, Please click <asp:Button ID="Button9" runat="server" Text="Save" OnClick="Button9_Click" />
                    </p> 
                    </form> 
                    <br />
                    <br />  
                    <p class="loginhere" style="color:white; margin:0">
                        Have already an account ? <a href="LoginForm.aspx" class="loginhere-link">Login here</a>
                    </p>
               </div> 
            </div>
        </section>
