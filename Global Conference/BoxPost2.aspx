<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BoxPost2.aspx.cs" Inherits="BoxPost2" %>
...
<body class="body">
   <form id="form1" runat="server">
            ...
            <div class="menu-area">
                <div class="ab">
                    <div class="menu-button">
                        <asp:Button ID="Button7" CssClass="Button" runat="server" Text="<< Home" OnClick="Button7_Click" />
                    ...
                    <div class="search-container">
                        <asp:TextBox placeholder="Search Opportunity" ID="SearchBox" runat="server" CssClass="input" ></asp:TextBox>
       ...
       <div style="width:100%;height:150px;">
           <img src="Images/Screenshot_3.png" style="width:100%;height:150px;border-radius: 40px;"/>
       </div>
       <div style="background-color:black;width:100%;height:200px;text-align:center;color:white;"> 
