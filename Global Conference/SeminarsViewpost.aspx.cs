...
public partial class SeminarsViewpost : System.Web.UI.Page
{
    ...
    protected void displaydata()
    {
        ...
        DataTable DT = new DataTable();
        SqlDataAdapter SDA = new SqlDataAdapter("Select id,title,region,city,heldingdate,applicationdeadline from PostForm where opportunitytype='Seminar'", conn);
        SDA.Fill(DT);
        conn.Close();
