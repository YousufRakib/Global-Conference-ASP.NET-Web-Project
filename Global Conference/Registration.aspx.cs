    ...
    protected void Button10_Click(object sender, EventArgs e)
    {
        if (uploadimage() == true)
        {
            ...
            using (conn)
            {
                ...
                SqlCommand cmd = new SqlCommand("Insert into RegistrationForm(fullname,username,email,password,country,city,mobile,age,image) values(@FullName,@Username,@Email,@Password,@Country,@City,@Mobile,@Age,@imagelink)", conn);
                ...
                cmd.Parameters.Add(new SqlParameter("@imagelink", imagelink));
                cmd.ExecuteNonQuery();
            }
