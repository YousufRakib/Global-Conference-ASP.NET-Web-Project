...
public partial class WorkshopsViewpost : System.Web.UI.Page
{
    ...
    protected void displaydata()
    {
        ...
        DataTable DT = new DataTable();
        SqlDataAdapter SDA = new SqlDataAdapter("Select id,title,region,city,heldingdate,applicationdeadline from PostForm where opportunitytype='Workshop'", conn);
        SDA.Fill(DT);
        conn.Close();
