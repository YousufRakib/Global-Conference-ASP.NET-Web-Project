...
<body class="body">
   <form id="form1" runat="server">
       ...
       <div style="width:100%;height:150px;">
           <img src="Images/Screenshot_9.png" style="width:100%;height:150px;border-radius: 40px;"/>
       </div>
       <div style="background-color:black;width:100%;height:250px;text-align:center;color:white;"> 
       <br />
       <br />
           <p style="font-size:25px;color:white;">
               Global Conference spreads opportunities for your convenience and ease based on available information, and thus, does not take any responsibility of unintended alternative or inaccurate information. As this is not the official page, we recommend you to visit the official website of opportunity provider for complete information. For organizations, this opportunity is shared with sole purpose of promoting “Access to Information” for all and should not be associated with any other purposes.
           </p>
       </div>
       <div class="footer">
