...
public partial class FiestPage : System.Web.UI.Page
{
    ...
    {
        //string oppartunitytype = TxtOppartunity.Value;
        //string region = TxtRegion.Value;
        Response.Redirect("BoxPost2.aspx?opportunitytype=" + TxtOpportunity.Value + "&region=" + TxtRegion.Value);
    }
