<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FullView.aspx.cs" Inherits="FullView" %>
...
<body class="body">
   <form id="form1" runat="server">
       ...
       <div style="background-color:grey;width:100%;height:600px;">
           ...
           <asp:Button ID="Button9" CssClass="Button" runat="server" Text="Click here" OnClick="Button9_Click" style="margin-left:10px;margin-right:10px;"/><br /><br />

           <asp:GridView ID="GridView1" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false" runat="server" style="margin-left:10px;margin-right:10px; border-radius:5px;" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
               ...
               <Columns>
                   <asp:TemplateField HeaderText="Opportunity ID">
                    ...
                    <asp:TemplateField HeaderText="Opportunity Title">
                        <ItemTemplate>
                   ...
                   <asp:TemplateField HeaderText="Opportunity Description">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("opportunitydescription") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField HeaderText="Benefit">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("benefit") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField HeaderText="Application Process">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("applicationprocess") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField HeaderText="Opportunity Type">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("opportunitytype") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField HeaderText="Funding Type">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("fundingtype") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField HeaderText="Application Deadline">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("applicationdeadline") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField HeaderText="Apply Link">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("applylink") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField HeaderText="Official Link">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("officiallink") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   ...
                   <asp:TemplateField HeaderText="Eligibilitie">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("eligibilitie") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField HeaderText="Official Contact Email">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("officialcontactEmail") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField HeaderText="Your Email Address">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("youremailaddress") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                   <asp:TemplateField HeaderText="Your Contact Number">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("yourcontactnumber") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
